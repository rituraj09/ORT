            ...
            <div class="search-box-wrapper">
                <div class="search-box container">
                    <ul class="search-tabs clearfix">
                        ...
                        <li><a ="#flights-tab" data-toggle="tab">FLIGHTS</a></li>
                        <li><a ="#flight-and-hotel-tab" data-toggle="tab">FLIGHT &amp; HOTELS</a></li>
                        <li><a ="#cars-tab" data-toggle="tab">CARS</a></li>
                        <li><a ="#cruises-tab" data-toggle="tab">CRUISES</a></li>
                        <li><a ="#flight-status-tab" data-toggle="tab">FLIGHT STATUS</a></li>
                        <li><a ="#online-checkin-tab" data-toggle="tab">ONLINE CHECK IN</a></li>
                    </ul>
                    <div class="visible-mobile">
                        <ul id="mobile-search-tabs" class="search-tabs clearfix">
                            <li class="active"><a href="#hotels-tab">HOTELS</a></li>
                            <li><a ="#flights-tab">FLIGHTS</a></li>
                    ...
                    <div class="col-sm-6 content-section description pull-right">
                        ...
                        <div class="row places image-box style9">
                            <div class="col-sms-4 col-sm-4">
                                <article class="box">
                                    <figure>
                                        <a ="hotel-list-view.html" title="" class="hover-effect yellow middle-block animated" data-animation-type="fadeInUp" data-animation-duration="1">
                            ...
                            <div class="col-sms-4 col-sm-4">
                                <article class="box">
                                    <figure>
                                        <a ="hotel-list-view.html" title="" class="hover-effect yellow middle-block animated" data-animation-type="fadeInUp" data-animation-duration="1" data-animation-delay="0.4"><img src="images/places02.jpg" alt="" width="175" height="175" /></a>
                                    </figure>
                                    <div class="details">
                            ...
                            <div class="col-sms-4 col-sm-4">
                                <article class="box">
                                    <figure>
                                       <a ="hotel-list-view.html" title="" class="hover-effect yellow middle-block animated" data-animation-type="fadeInUp" data-animation-duration="1" data-animation-delay="0.8"><img src="images/places03.jpg" alt="" width="340" height="226" /></a>
                                    </figure>
                                    <div class="details">
...
Nullam placerat lacinia dolor quis pretium. Phasellus vitae lacinia quam, at pellentesque lorem. Sed euismod turpis quis mattis fringilla.--></p>
                    <div class="row image-box style2">
                        <div class="col-md-6">
                            <article class="box">
                                <figure class="animated" data-animation-type="fadeInLeft" data-animation-duration="1">
                                    <a href="#" title=""><img src="images/offers01.jpg" alt="" width="272" height="192" /></a>
                                </figure>
                                <div class="details">
                                    <h4>Hire Cars</h4>
                        ...
                        <div class="col-md-6">
                            <article class="box">
                                <figure class="animated" data-animation-type="fadeInLeft" data-animation-duration="1" data-animation-delay="0.4">
                                    <a href="#" title=""><img src="images/offers02.jpg" alt="" width="272" height="192" /></a>
                                </figure>
                                <div class="details">
                                    <h4>Cruise Deals</h4>
                                    <p>Nunc cursus libero purus ac congue ar lorem cursus ut sed vitae pulvinar massa idend porta nequetiam elerisque mi id.</p>
                        ...
                        <div class="col-md-6">
                            <article class="box">
                                <figure class="animated" data-animation-type="fadeInLeft" data-animation-duration="1">
                                    <a href="#" title=""><img src="images/offers03.jpg" alt="" width="272" height="192" /></a>
                                </figure>
                                <div class="details">
                                    <h4>Things To Do</h4>
                                    <p>Nunc cursus libero purus ac congue ar lorem cursus ut sed vitae pulvinar massa idend porta nequetiam elerisque mi id.</p>
                        ...
                        <div class="col-md-6">
                            <article class="box">
                                <figure class="animated" data-animation-type="fadeInLeft" data-animation-duration="1" data-animation-delay="0.4">
                                    <a href="#" title=""><img src="images/offers04.jpg" alt="" width="272" height="192" /></a>
                                </figure>
                                <div class="details">
                    ...
                    <div class="row image-box style7">
                        ...
                        <div class="col-sms-6 col-sm-6 col-md-3">
                             <article class="box">
                                ...
                                <div class="details">
                                    <h4><a href="#">Active Customer Care</a></h4>
                                    <p>
