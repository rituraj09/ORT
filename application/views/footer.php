...
<!--                                <li class="col-xs-12"><a href="articlesss">ARTICLES</a></li>-->
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <ul class="discover triangle hover row">
                                <li class="col-xs-12"><a href="popular_destinations/california">California Vacations</a></li>
                                <li class="col-xs-12"><a href="popular_destinations/caribbean">Caribbean Vacations</a></li>
                                <li class="col-xs-12"><a href="popular_destinations/florida">Florida Vacations</a></li>
                                <li class="col-xs-12"><a href="popular_destinations/hawaii">Hawaii Vacations</a></li>
                                <li class="col-xs-12"><a href="popular_destinations/las_vegas">Las Vegas Vacations</a></li>
                                <li class="col-xs-12"><a href="popular_destinations/mexico">Mexico Vacations</a></li>
                            </ul>
                           <div align="center"> 
                                        ...
                                        <a  href="https://www.facebook.com/OneRoofTravel/"><img height="30px" width="30px" src="assets/images/facebook_logo.png"/></a>
                                                      <a href="https://plus.google.com/117931739287905395444"><img height="30px" width="30px" src="assets/images/googleplus.png" /></a>
                                                       <!-- <a href="http://facebook.com/"><img height="30px" width="30px" src="assets/images/linkedin.png" /></a> -->
                                                        <a href="https://twitter.com/Onerooftravel1"><img height="30px" width="30px" src="assets/images/twitter.png" /></a></span>
